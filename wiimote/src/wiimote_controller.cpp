...
bool WiimoteNode::publishWiimoteNunchukCommon()
{
  ...
  //
  // TODO: Could be improved by a true user interaction calibration to find
  // the center of the joystick, the max and min for each x and y.
